...
import {isArray, extend, toPlainArray, isOriginalTag, isDomNode, isString, isFunction, deserializeValue, typeHandlers, document} from './utils.js';
...
import {createNative, renderNative} from './nativeElementUtils.js'
...
function create(type, initAttr, ...children) {
    ...
    return createNative.apply(this, [].slice.call(arguments));
    ...
    if (isOriginalTag(type)) {
        ...
        extend(vTree.properties.attributes, initAttr, {
